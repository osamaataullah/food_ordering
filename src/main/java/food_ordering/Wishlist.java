...
public class Wishlist {
    ...
    public void display_wishlist() {
        ...
        String query = "select m.estimated_time, o.menu_id, m.menu_name, o.quantity, o.quantity * m.price  from orders as o inner join menu as m on o.menu_id = m.menu_id  and o.order_status = 'ADDED_TO_WISHLIST' and o.user_id ="
                + Login.user_id;
        try {
