...
public class Track {
        ...
        while(true) {
            ...
            if (inp == 1 && late == false) {
                ...
                if(delivery_status)
                    ...
                    System.out.println("Sorry! we're running late unexpectedly.\n Please wait or you may cancel your order.");
                display_track_menu();
            }
            else if(inp == 2){
    ...
    public void simulate_delivered() {
        String query = "update orders set order_status=\"DELIVERED\" where order_status = 'payment_done' and user_id = " + Login.user_id;
