...
public class payment {
    ...
    public int Calculate_Bill() {
        ...
        try {
            ...
            String query = "Select m1.price, o1.quantity from menu m1 join orders o1 on m1.menu_id=o1.menu_id where o1.order_status = 'ADDED_TO_CART' AND o1.user_id ="
                    + Login.user_id;
            ...
            if (tcost >= 100) {
                ...
                String query1 = "UPDATE orders set order_status = 'payamount' where order_status = 'ADDED_TO_CART' AND user_id="
                        + Login.user_id;
                ...
                System.out.println("Insufficient Items please order more food for delivery min " + (100 - tcost)
                        + " rupees more items");
    ...
    private int calculate_delivery_charges() {
        ...
        try {
            ...
            String distance_query = "SELECT distance FROM city_area_distance where area1=\"" + restaurant_area
                    + "\" and area2=\"" + user_area + "\"";
